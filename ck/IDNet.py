...
dirCheckpoints = dirRoot + '/code/PSNRL/checkpoints/idnet_ck'
...
parameters = list(encoderF.parameters()) + list(classifier.parameters())
...
def train_classifier(k):
    ...
    for epoch in range(args.nepoch):
        ...
        for i, batch in enumerate(dataloader):
            ...
            if i % 50 == 0:
                acc = test_classifier(iteration_count, k)
                if acc > bestacc and acc > 87.0:
                    bestacc = acc
