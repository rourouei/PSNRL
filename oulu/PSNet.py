...
dirCheckpoints = dirRoot + '/code/PSNRL/checkpoints/residue_vis'
...
load_encoderF =  dirRoot + '/code/PSNRL/checkpoints/residue_vis/model/encoderI_epoch_3.pth'
    ...
    for epoch in range(10):
        ...
        for i, batch in enumerate(dataloader):
            ...
            if i % 500 == 0:
                ...
                torch.save(extractor.state_dict(), '{}/extractor_epoch_{}.pth'.format(dirModel, iteration_count))
